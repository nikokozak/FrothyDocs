...
description: "The narrow Frothy/C boundary, project FFI, and board FFI."
weight: 9
---
...
You call FFI words with ordinary Frothy syntax:
...
their own `board.json`, `ffi.h`, `ffi.c`, and base library. Frothy then decides
which names become part of the public base-image surface.

## Persistence Boundary

Native runtime state does not persist. The persistent part is the Frothy image,
